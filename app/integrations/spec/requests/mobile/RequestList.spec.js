...
describe.only('Home Page', () => {
	...
	test('should request attendance well', async () => {
		...
		await page.waitForSelector('.v-input #input-58');
		...
		await page.waitForSelector('.v-input #input-64');
		await page.click('.v-input #input-64')
		await matchImage();
		...
		await page.waitForSelector('.v-input #input-69');
		await page.click('.v-input #input-69');
		await matchImage();
